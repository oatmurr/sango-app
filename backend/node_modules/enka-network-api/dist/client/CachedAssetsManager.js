...
class CachedAssetsManager {
    ...
    async fetchLanguageData(lang) {
        ...
        if (lang === "th") {
            const json1 = (await (0, axios_utils_1.fetchJSON)(`${contentBaseUrl}/TextMap/TextMap${lang.toUpperCase()}_1.json`, this.enka)).data;
            const json2 = (await (0, axios_utils_1.fetchJSON)(`${contentBaseUrl}/TextMap/TextMap${lang.toUpperCase()}_2.json`, this.enka)).data;
    ...
    async updateContents(options = {}) {
        ...
        await this.cacheDirectorySetup();
        const url = getGitRemoteAPIUrl(mergedOptions.useRawGenshinData, new Date(((_b = (_a = this._githubCache) === null || _a === void 0 ? void 0 : _a.getValue("rawLastUpdate")) !== null && _b !== void 0 ? _b : 0)), new Date(((_d = (_c = this._githubCache) === null || _c === void 0 ? void 0 : _c.getValue("lastUpdate")) !== null && _d !== void 0 ? _d : 0)));
        const res = await (0, axios_utils_1.fetchJSON)(url, this.enka);
        if (res.status !== 200) {
            throw new Error("Request Failed");
        }
        const data = res.data;
        if (data.length !== 0) {
            await ((_e = mergedOptions.onUpdateStart) === null || _e === void 0 ? void 0 : _e.call(mergedOptions));
            ...
            await ((_f = mergedOptions.onUpdateEnd) === null || _f === void 0 ? void 0 : _f.call(mergedOptions));
        }
    }
    /**
     * @param options.useRawGenshinData Whether to fetch from gitlab repo ({@link https://gitlab.com/Dimbreath/AnimeGameData}) instead of downloading cache.zip
