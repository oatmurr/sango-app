...
class Artifact {
    constructor(data, enka) {
        ...
        const splitSubStats = reliquary.has("appendPropIdList") ? (_c = reliquary.get("appendPropIdList")) === null || _c === void 0 ? void 0 : _c.mapArray((_, id) => ArtifactSplitSubstat_1.ArtifactSplitSubstat.getById(id.getAsNumber(), enka)) : [];
        this.substats = {
